...
public class BroadcastDepositListener {

  private final TopicProperties topicProperties;
  private final JsonUtils jsonUtils;
  private final DepositValue depositValue;

  @KafkaListener(
      topics = "${spring.kafka.topics.depositValueBroadcast}",
  ...
  public void listener(
    ...
    log.debug(
        ...
        message);
    try {
      final var resource = jsonUtils.toObject(message, AccountResource.class);
      depositValue.execute(resource.toDomain());
