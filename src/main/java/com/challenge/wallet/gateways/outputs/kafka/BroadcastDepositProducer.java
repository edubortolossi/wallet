...
public class BroadcastDepositProducer {
  ...
  public void send(final Account account) {
    final var message = jsonUtils.toJson(account);
    final var topic = topicProperties.getDepositValueBroadcast();
    final var partitionKey = account.getCpf()+"_"+account.getAccountNumber();
